...
new_text_2="https://fastly.jsdelivr.net/gh/Become-ILLUSORY/what-can-i-say@main/PG/token.json"
...
jq '.sites[] |= if .key == "AList" then .ext = "http://192.168.1.1/pg/alistjar.json" else . end' "$downloaded_file_1" > temp.json
